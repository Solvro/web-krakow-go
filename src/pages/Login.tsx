        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            {!isLogin && <div className="space-y-2">
                ...
                <Input id="name" type="text" placeholder="Jan Kowalski" value={name} onChange={e => setName(e.target.value)} required={!isLogin} className="h-14" />
              </div>}
            ...
            <div className="space-y-2">
              ...
              <Input id="email" type="email" placeholder="jan@example.com" value={email} onChange={e => setEmail(e.target.value)} required className="h-14" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Input id="password" type="password" placeholder="••••••••" value={password} onChange={e => setPassword(e.target.value)} required className="h-14" />
            ...
            {isLogin && <>
                ...
                <div className="grid grid-cols-3 gap-3">
                  <Button type="button" variant="outline" className="h-14" onClick={() => handleQuickLogin('volunteer')}>
                    Wolontariusz
                  </Button>
                  <Button type="button" variant="outline" className="h-14" onClick={() => handleQuickLogin('coordinator')}>
                    Koordynator
                  </Button>
                  <Button type="button" variant="outline" className="h-14" onClick={() => handleQuickLogin('organizer')}>
                    Organizator
                  </Button>
                </div>
              </>}
            ...
            <div className="grid grid-cols-2 gap-4">
              <Button type="button" variant="outline" className="h-14 gap-2" onClick={() => toast({
              title: "Demo",
              description: "Logowanie przez Google niedostępne w wersji demo."
            })}>
              ...
              <Button type="button" variant="outline" className="h-14 gap-2" onClick={() => toast({
              title: "Demo",
              description: "Logowanie przez Facebook niedostępne w wersji demo."
            })}>
